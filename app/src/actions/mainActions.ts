...
export namespace mainActions {
  ...
  export const handleServiceClick = createAction<PartialPick<MainModel, 'selectedService'>>(Type.HANDLE_SERVICE_CLICK)
  export const handleRequestClick = createAction<PartialPick<MainModel, 'selectedRequest'>>(Type.HANDLE_REQUEST_CLICK)
