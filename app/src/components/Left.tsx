...
export default function Left(props: LeftProps.Props, context?: any) {
  ...
  if(props.mode === 'service') mode = <Service serviceList={serviceList} requestList={requestList}/>
  ...
  return (
    <div className="left">
      ...
      <div className="tabs">
        <button onClick={() => props.setMode('service')} className="service-button">Service</button>
        <button onClick={() => props.setMode('request')}  className="request-button">Request</button>
        <button onClick={() => props.setMode('setup')}  className="req-setup-button">Request Setup</button>
      </div>
      <div className="main">
        {mode}
      </div>
